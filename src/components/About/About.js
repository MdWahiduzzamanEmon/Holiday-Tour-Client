            ...
            <div className="row align-items-center ">
              <div className="col-md-6">
                <p className="text-secondary text-start fw-bold">
                  ...
                  wilderness and untouched nature. In the last few decades
                  tourism has grown very much, mostly because people’s
                  lifestyles have changed. They don’t want to stay at home any
                  more. They spend more money on travelling than previous
                  generations did. Travelling has also become cheaper and more
                  affordable. The rise of budget airlines has made it possible
                  to afford trips to faraway countries.
                </p>
              </div>
              <div className="col-md-6">
                <Benefits />
